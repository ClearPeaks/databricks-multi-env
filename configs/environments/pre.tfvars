# Required variables
location                  = "uksouth"
spoke_resource_group_name = "rg-dbs-pre-env"
project_name              = "dbs-poc"
environment_name          = "pre"
spoke_vnet_address_space  = "10.0.0.0/16"

databricks_workspace_name       = "dbw-poc-pre"
...
managed_resource_group_name = "rg-databricks-managed-pre"
storage_account_names       = ["stadbs-poc-pre"]
# data_factory_name              = "adf-dbs-poc-pre"
# key_vault_name                 = "kv-dbs-poc-pre"
